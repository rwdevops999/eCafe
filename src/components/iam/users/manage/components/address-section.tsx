        ...
        <div className="w-[100%] grid grid-cols-12 space-x-2">
          <div className="col-span-4">
            <div className="grid grid-cols-8 items-center space-x-2">
              ...
              <select {...register("country")} className="px-2 py-1 text-sm col-span-5 border-[1px] rounded-sm h-8 border-foreground/10 bg-background outline-foreground/10" onChange={changeCountry}>
